...
impl<'module_environment> TargetEnvironment for FuncEnvironment<'module_environment> {
    ...
    fn reference_type(&self, ty: WasmHeapType) -> ir::Type {
        crate::cranelift::reference_type(ty, self.pointer_type())
    }
...
impl<'module_environment> cranelift_wasm::FuncEnvironment for FuncEnvironment<'module_environment> {
    ...
    fn make_indirect_sig(
        ...
        let sig =
            crate::cranelift::wasm_call_signature(self.isa, &self.types[index], &self.tunables);
    ...
    fn make_direct_func(
        ...
        let sig = crate::cranelift::wasm_call_signature(self.isa, &self.types[sig], &self.tunables);
